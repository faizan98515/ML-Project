...
# Applying Grid Search to optimize Random Forest parameters
...
# Applying Random Search to optimize Random Forest parameters
...
random_search = RandomizedSearchCV(estimator=rf, param_distributions=param_dist, scoring='accuracy', cv=5, n_iter=20, verbose=1, n_jobs=-1, random_state=0)
